...
- Issue #441 is complete and merged via PR #443 at `87aee71be7e86ddd837c53b2f93edd29405f808c`: commerce/choice evidence sources bridge into the existing Marketing Library registration/review path with exact mixed access coverage + review-only finding/limitations/jurisdiction. No activation occurred. CA MANUAL 02 now owns Issue #444 / `feat/444-competitive-creative-library-bridge` for the next source-preserving competitive-creative registration slice.
