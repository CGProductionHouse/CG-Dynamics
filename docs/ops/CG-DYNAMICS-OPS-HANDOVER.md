...
- Issue #441 is complete and merged via PR #443 at `87aee71be7e86ddd837c53b2f93edd29405f808c`. Issue #444 is also complete and merged via PR #445 at `1f130e637ce8a79efc4aa570a4b290a248f286cd`: competitive-creative sources use explicit evidence-ID classification with exact coverage + review-only context; M0 remains non-documentation and unknown IDs fail closed. No Library activation occurred. CA MANUAL 02 now owns Issue #446 / `feat/446-unified-research-registration-preview` to combine the seed manifest + #426/#441/#444 bridge outputs into the existing admin Registration preview without writes.
