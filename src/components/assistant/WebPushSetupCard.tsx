...
export function WebPushSetupCard() {
  ...
  return (
    <section className="mb-5 overflow-hidden rounded-xl border border-brand-teal/20 bg-[radial-gradient(circle_at_top_right,rgba(26,183,173,0.12),transparent_45%),rgba(8,15,13,0.92)] p-4 sm:p-5" aria-labelledby="push-setup-heading">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <p className="text-[10px] font-black uppercase tracking-[0.18em] text-brand-teal">iPhone reminders</p>
          <h2 id="push-setup-heading" className="mt-1 text-lg font-black text-white">Lock Screen notifications</h2>
          <p className="mt-1 max-w-2xl text-sm leading-relaxed text-brand-primary/70">
      ...
      <ol className="mt-4 grid gap-2 text-sm text-brand-primary/80 sm:grid-cols-2 xl:grid-cols-4">
