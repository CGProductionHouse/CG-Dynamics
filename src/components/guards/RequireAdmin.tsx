  ...
  return (
    <div className="min-h-screen bg-brand-bg flex items-center justify-center p-6">
      <div className="max-w-md rounded-xl border border-white/10 bg-brand-surface p-6 text-center shadow-2xl">
        <p className="text-xs font-black uppercase tracking-[0.2em] text-brand-accent">Admin only</p>
        <h1 className="mt-2 text-xl font-semibold text-white">You do not have access to this area.</h1>
        <p className="mt-2 text-sm text-brand-primary">
          Ask an admin if you need user management or system setup access.
        </p>
      </div>
    </div>
  )
