-- ============================================================================
-- Microsoft Calendar client enrichment
--
-- This migration carries forward the current phase-21a apply RPC and also
-- allows its Calendar update branch to accept optional client_id/client_name
-- fields. The frontend sends those fields only when a reviewed Outlook label
-- can fill an empty client link. Existing non-null links remain CG-owned.
--
