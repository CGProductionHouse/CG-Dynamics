...
test('worker lanes default to one pending live acceptance and are hard-capped at six', () => {
  assert.equal(DEFAULT_META_WORKER_LANES, 1)
  assert.equal(MAX_META_WORKER_LANES, 6)
  assert.deepEqual(normalizeMetaWorkerLanes({}), { workerLane: 0, workerLanes: 1, startsLaneSet: false })
